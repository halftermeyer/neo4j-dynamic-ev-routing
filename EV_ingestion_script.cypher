...
CREATE (cs1:ChargingStation {lat: 48.7566, lon: 2.4522, id: 'CS1', power_kw: 150}),
 (cs2:ChargingStation {lat: 45.8640, lon: 4.7357, id: 'CS2', power_kw: 200}),
 (cs3:ChargingStation {lat: 43.3965, lon: 5.4698, id: 'CS3', power_kw: 350}),
 (cs4:ChargingStation {lat: 44.7378, lon: -0.4792, id: 'CS4', power_kw: 100}),
 (cs5:ChargingStation {lat: 48.4734, lon: 7.8521, id: 'CS5', power_kw: 250}),
 (cs6:ChargingStation {lat: 50.5292, lon: 3.1573, id: 'CS6', power_kw: 150}),
 (cs7:ChargingStation {lat: 43.5047, lon: 1.5442, id: 'CS7', power_kw: 200}),
 (cs8:ChargingStation {lat: 43.6102, lon: 7.3620, id: 'CS8', power_kw: 300}),
 (cs9:ChargingStation {lat: 47.1184, lon: -1.4536, id: 'CS9', power_kw: 120}),
 (cs10:ChargingStation {lat: 43.5108, lon: 3.9767, id: 'CS10', power_kw: 180});
...
MATCH (a:OP {id: 'OP1'}), (b:OP {id: 'OP2'}) CREATE (a)-[:ROAD {distance_km: 450.0, speed_limit_kph: 110}]->(b);
MATCH (a:OP {id: 'OP3'}), (b:OP {id: 'OP4'}) CREATE (a)-[:ROAD {distance_km: 600.0, speed_limit_kph: 120}]->(b);
MATCH (a:OP {id: 'OP5'}), (b:OP {id: 'OP6'}) CREATE (a)-[:ROAD {distance_km: 400.0, speed_limit_kph: 110}]->(b);
MATCH (a:OP {id: 'OP7'}), (b:OP {id: 'OP8'}) CREATE (a)-[:ROAD {distance_km: 500.0, speed_limit_kph: 110}]->(b);
MATCH (a:OP {id: 'OP9'}), (b:OP {id: 'OP10'}) CREATE (a)-[:ROAD {distance_km: 700.0, speed_limit_kph: 120}]->(b);
MATCH (a:POI {name: 'Louvre'}), (b:POI {name: 'Basilica'}) CREATE (a)-[:ROAD {distance_km: 450.0, speed_limit_kph: 110}]->(b);
MATCH (a:POI {name: 'Old Port'}), (b:POI {name: 'Wine Museum'}) CREATE (a)-[:ROAD {distance_km: 600.0, speed_limit_kph: 120}]->(b);
MATCH (a:POI {name: 'Cathedral'}), (b:POI {name: 'Citadel'}) CREATE (a)-[:ROAD {distance_km: 400.0, speed_limit_kph: 110}]->(b);
MATCH (a:POI {name: 'Capitol'}), (b:POI {name: 'Promenade'}) CREATE (a)-[:ROAD {distance_km: 500.0, speed_limit_kph: 110}]->(b);
MATCH (a:POI {name: 'Château'}), (b:POI {name: 'Aqueduct'}) CREATE (a)-[:ROAD {distance_km: 700.0, speed_limit_kph: 120}]->(b);
...
MERGE (cs)-[:CHARGE {station_id:cs.id, power_kw: cs.power_kw,
time_in_minutes: 30}]->(cs);
...
WITH x, r, y
MERGE (x)-[:ROAD {distance_km: r.distance_km, speed_limit_kph:80}]->(y);